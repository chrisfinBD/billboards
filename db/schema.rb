...
ActiveRecord::Schema.define(version: 2020_01_14_045607) do
  ...
  create_table "billboards_songs_tables", force: :cascade do |t|
    t.bigint "billboard_id"
    t.bigint "song_id"
    t.index ["billboard_id"], name: "index_billboards_songs_tables_on_billboard_id"
    t.index ["song_id"], name: "index_billboards_songs_tables_on_song_id"
  end
